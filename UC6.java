 ...
 * in the "Book My Stay" Hotel Booking System (version 6.0).
 *
 * Booking requests are processed in FIFO order, inventory is updated,
 * and double-booking is prevented using a Set for allocated room IDs.
 *
 * Version: 6.0
 * Author: YourName
 */
